...
翻看博客的数据，发现 2020 年写的《[在家庭网络中使用RouterOS路由器全局翻墙](/routeros/vpn/2020/01/01/ros-vpn-gfw-l2tp.html)》依然有很多访问量。时过境迁，网络封锁技术在不断升级，当年推荐的 L2TP 协议虽然能用，但在目前的网络环境下已经显得力不从心，极易受到干扰。
...
依然推荐选择延迟和丢包率表现相对优秀的[日本东京机房](https://www.vultr.com/?ref=8060999)。服务器操作系统推荐安装 **Ubuntu 22.04**。
